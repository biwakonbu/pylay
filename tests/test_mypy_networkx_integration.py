...
class TestNetworkXIntegration:
    ...
    def test_networkx_adapter_creation(self):
        ...
        edges = [
            GraphEdge(source='User', target='str', relation_type='references', weight=0.8)
        ]
    ...
    def test_topological_sort(self):
        ...
        edges = [
            GraphEdge(source='Derived', target='Base', relation_type='inherits'),  # Derived -> Base
    ...
    def test_graph_statistics(self):
        ...
        nodes = [
            ...
            GraphNode(name='C', node_type='variable')
        ]
        edges = [
            GraphEdge(source='A', target='B', relation_type='calls'),
            GraphEdge(source='B', target='C', relation_type='references')
        ]
        graph = TypeDependencyGraph(nodes=nodes, edges=edges)
    ...
    def test_strong_dependency_subgraph(self):
        ...
        edges = [
            GraphEdge(source='A', target='B', relation_type='inherits', weight=0.9),  # 強い
...
class TestCLIEnhancements:
    ...
    def test_cli_with_mypy_option(self):
        ...
        from generate_dependency_graph import generate_dependency_docs
