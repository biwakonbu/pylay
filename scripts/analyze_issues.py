...
class ProjectAnalyzer:
    ...
    def check_type_checking(self) -> CheckResult:
        ...
        mypy_files = [
            "converters/type_to_yaml.py", "converters/yaml_to_type.py",
            "doc_generators/yaml_doc_generator.py", "doc_generators/base.py",
            "doc_generators/config.py", "schemas/yaml_type_spec.py", "schemas/type_index.py"
        ]
        return self.run_command(
    ...
    def print_summary(self, summary: dict[str, Any]):
        ...
        print(f"✅ 成功したチェック: {summary['successful_checks']}/{summary['total_checks']}")
        print(f"❌ 失敗したチェック: {summary['failed_checks']}/{summary['total_checks']}")
        print(f"⚠️ 問題のあるチェック: {summary['checks_with_issues']}/{summary['total_checks']}")
        ...
        for result in summary['results']:
            ...
            if result['has_issues']:
                print(f"    - 出力行数: {result['output_lines']}, エラー行数: {result['error_lines']}")
